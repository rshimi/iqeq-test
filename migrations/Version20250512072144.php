 ...
 */
final class Version20250512072144 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE vehicle_information CHANGE registration_date registration_date DATE DEFAULT '2010-10-10' NOT NULL
        SQL);
    }
}
